        ...
        <div style={{overflowX:"auto",overflowY:"auto",position:"relative",
          ...
          <div style={{minWidth:(1000+200*zoom)*tZoom}}>
            ...
            <div style={{display:"flex",position:"sticky",top:0,zIndex:8,
              ...
              <div style={{flex:1,display:"flex",paddingTop:4,paddingBottom:4}}>
              {tMarks.map((t,i)=>(
                ...
                <div key={venue} style={{display:"flex",borderBottom:"1px solid #141420",minHeight:numRows*rowH+6,
                  ...
                  <div style={{width:vcW,minWidth:vcW,padding:mob?"3px 4px":"5px 10px",borderRight:"2px solid #1e1e2a",
                    ...
                    <div style={{fontSize:mob?8:11*zoom,fontWeight:700,color:"#ccc",lineHeight:1.2,
                      overflow:"hidden",textOverflow:"ellipsis",whiteSpace:mob?"nowrap":"normal"}}>{venue}</div>
                  ...
                  <div style={{flex:1,position:"relative",minHeight:numRows*rowH}}>
                    ...
                    {nowH>0&&(()=>{
                      ...
                      if(nh>=tStart&&nh<=tEnd){
                        ...
                        return <div style={{position:"absolute",left:`${left}%`,top:0,bottom:0,width:2,
                          ...
                          <div style={{position:"absolute",top:-2,left:-10,background:"#06D6A0",
                            color:"#000",fontSize:8,fontWeight:800,padding:"1px 4px",borderRadius:3,
                    ...
                    {rows.map((row,ri)=>row.map(evt=>{
                      ...
                      return(
                        <div key={evt.id}
                          onClick={(e)=>{if(mob){const r=e.currentTarget.getBoundingClientRect();if(hov===evt.id){toggleSched(evt.id);}else{setHov(evt.id);setHovRect(r);setExpanded(true);startExpand(evt);}}else{toggleSched(evt.id);}}}
